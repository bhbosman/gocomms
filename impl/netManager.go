...
func (self *NetManager) NewConnectionInstance(connectionType commsInternal.ConnectionType, conn net.Conn) (*fx.App, context.Context) {
	...
	fxApp := fx.New(
		...
		fx.Invoke(internal2.InvokeFxLifeCycleReadDataFromConnectionStartStop),
		fx.Invoke(internal2.InvokeFxLifeCycleIncomingObsStartStop),
		fx.Invoke(internal2.InvokeFxLifeCycleOutgoingObsStartStop),
		fx.Invoke(internal2.InvokeFxLifeCycleStackStateStartStop),
		fx.Invoke(internal2.InvokeFxLifeCyclePipeStateInStartStop),
		fx.Invoke(internal2.InvokeFxLifeCyclePipeStateOutStartStop),
		fx.Invoke(internal2.InvokeFxLifeCycleConnectionReactorStartStop),
	)
	return fxApp, ctx
}
